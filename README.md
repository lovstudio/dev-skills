...
| ![Free](https://img.shields.io/badge/Free-green) | [`cc-migrate-session`](https://github.com/lovstudio/cc-migrate-session/tree/main/skill/sgc-cc-mv) | [会话迁移](https://github.com/lovstudio/cc-migrate-session/tree/main/skill/sgc-cc-mv) | 项目目录搬家后，让 Claude Code 的历史会话还能正常 `--resume`。 |
