...
```bash
python3 "${LOVSTUDIO_APP_GENERATOR_SKILL_DIR:-$HOME/.claude/skills/lovstudio-app-generator}/scripts/audit_app_project.py" --root /path/to/app --app-type auto
python3 "${LOVSTUDIO_APP_GENERATOR_SKILL_DIR:-$HOME/.claude/skills/lovstudio-app-generator}/scripts/audit_app_project.py" --root /path/to/app --app-type web --format json
python3 "${LOVSTUDIO_APP_GENERATOR_SKILL_DIR:-$HOME/.claude/skills/lovstudio-app-generator}/scripts/audit_app_project.py" --root /path/to/app --app-type tauri --format markdown
```
